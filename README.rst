...
replace all instances of ``frontend-undar-examen`` with the name of
...
This section concerns development of ``frontend-undar-examen`` itself,
...
.. _Feature-based Application Organization ADR: https://github.com/DaveARG/frontend-undar-examen/blob/master/docs/decisions/0002-feature-based-application-organization.rst
...
https://github.com/DaveARG/frontend-undar-examen/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/frontend-undar-examen
...
.. |license-badge| image:: https://img.shields.io/github/license/openedx/frontend-undar-examen.svg
    :target: https://github.com/DaveARG/frontend-undar-examen/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/DaveARG/frontend-undar-examen/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/DaveARG/frontend-undar-examen/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openedx/frontend-undar-examen/coverage.svg?branch=main
    :target: https://codecov.io/github/openedx/frontend-undar-examen?branch=main
    :alt: Codecov
